...
services/web_admin/
├── api/
│   ├── app.py              # FastAPI приложение (58 endpoint'ов)
...
Управление Web источниками: добавление URL, настройка CSS-селекторов, ручной запуск парсинга.
API endpoint'ы:
...
| GET | `/web/news` | Список Web новостей |
